...
class RecognitionEngine:
    ...
    # ==============================================================
    # PREPROCESAMIENTO EXCLUSIVO DE LA CÁMARA PI
    # ==============================================================

    def _prepare_face_for_pi(self, face):

        """
        Preprocesamiento utilizado únicamente por la
        cámara Raspberry Pi.

        La cámara USB NO pasa por esta función.

        Se normaliza el tamaño y se mejora el contraste
        local mediante CLAHE para compensar diferencias
        de iluminación entre ambas cámaras.
        """
    ...
    def _process_frame_locked(
        ...
        for (x, y, w, h) in faces:
            ...
            if self.ready:
                ...
                #
                # NO SE MODIFICA.
                # Utiliza exactamente el recorte original.
                # ==================================================

                if camera_source == "usb":

                    face_for_prediction = face_roi


                # ==================================================
                # RASPBERRY PI
                #
                # Aplicar el nuevo preprocesamiento únicamente
                # a la cámara Pi.
                # ==================================================
